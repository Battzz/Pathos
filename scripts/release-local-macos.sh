...
required_vars=(
  PATHOS_UPDATER_ENDPOINTS
  PATHOS_UPDATER_PUBKEY
...
echo "Building Pathos macOS release..."
bun x tauri build --bundles app,dmg --ci

APP_BUNDLE="${ROOT_DIR}/src-tauri/target/release/bundle/macos/Pathos.app"
...
echo "  - src-tauri/target/release/bundle/macos/Pathos.app.tar.gz"
echo "  - src-tauri/target/release/bundle/macos/Pathos.app.tar.gz.sig"
echo
