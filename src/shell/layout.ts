...
export const SIDEBAR_WIDTH_STORAGE_KEY = "pathos.workspaceSidebarWidth";
export const INSPECTOR_WIDTH_STORAGE_KEY = "pathos.workspaceInspectorWidth";
export const PREFERRED_EDITOR_STORAGE_KEY = "pathos.preferredEditorId";
