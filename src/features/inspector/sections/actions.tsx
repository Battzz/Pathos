	...
	return (
		<DropdownMenu>
			...
			<DropdownMenuContent
				...
				align="end"
				sideOffset={4}
				className="max-h-[min(32rem,calc(100vh-4rem))] w-[22rem] overflow-y-auto p-0"
			>
				<div className="bg-muted/18 py-1 text-[11.5px]">
					<ActionsRows model={model} />
				</div>
			</DropdownMenuContent>
		</DropdownMenu>
	);
...
function useWorkspaceActionsModel({
	workspaceId,
	workspaceState,
	repoId,
	workspaceRemote,
