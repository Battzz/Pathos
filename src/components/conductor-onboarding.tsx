...
function WorkspaceRow({
	...
	const transferring = phase === "importing" && !forPathos;
	const shouldAnimateEntrance = forPathos;
...
export function ConductorOnboarding({
	...
	const pathosAnchorRef = useRef<BeamAnchorElement>(null);
	...
	// unmount them to free up the flex layout — Pathos can then slide to
		...
		>
			...
			<LayoutGroup>
				...
				>
					...
					{/* RIGHT: Pathos — layout-animated to center when the aux columns exit */}
					<motion.div
						layout
