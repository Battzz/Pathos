/**
 * React Profiler aggregator for Pathos.
 *
 ...
 *   </PathosProfiler>
 *
 * When the flag is off, <PathosProfiler> is a passthrough: it returns
 * `children` directly with zero React.Profiler overhead.
 *
 * Programmatic readback:
 *
 *   window.__PATHOS_PROFILER__.summary()  // sorted by total mount+update ms
 *   window.__PATHOS_PROFILER__.clear()    // reset between scenarios
 */
 ...
 */
export function PathosProfiler({
	id,
	children,
}: {
	id: string;
